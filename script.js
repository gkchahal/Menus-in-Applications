...
function nav(){
  ...
  navEle.appendChild(otherButton);
  document.body.appendChild(navEle); 
}

function initRoot(){
  var root = document.createElement("div")
  root.classList.add("initroot");
  document.body.appendChild(initroot);
}

function home(){
  document.body.querySelector(".initroot").innerHTML="Home"
}

function other(){
  document.body.querySelector(".initroot").innerHTML="Other"
}
